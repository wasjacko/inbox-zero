...
const initialConversations: InboxConversation[] = [
  ...
  },
  {
    ...
    name: "Léa Dumont",
    initials: "LD",
    address: "#brand-review",
    channel: "slack",
    contactType: "collaborator",
    subject: "Validation de la nouvelle direction visuelle",
    preview:
      "J’ai regroupé les deux variantes dans Figma. La version B semble faire consensus.",
    time: "6 min",
    unread: true,
    labels: ["urgent"],
    project: "Identité de marque Aurélia",
    ...
    messages: [
      {
        id: "lea-brand-1",
        author: "contact",
        body: "J’ai regroupé les deux variantes dans Figma. La version B semble faire consensus.",
        time: "11:18",
      },
      {
        id: "lea-brand-2",
        author: "contact",
        body: "Il nous manque seulement ton accord sur la palette secondaire avant d’exporter les composants.",
        time: "11:20",
      },
    ],
  },
  {
    ...
    name: "Karim Benali",
    initials: "KB",
    address: "karim@atelier-mosaic.fr",
    channel: "gmail",
    contactType: "client",
    subject: "Dernière précision avant validation du devis",
    preview:
      "Peux-tu ajouter l’accompagnement au lancement dans la proposition finale ?",
    time: "24 min",
    unread: true,
    labels: ["follow-up"],
    project: "Espace Meridian",
    ...
    messages: [
      {
        id: "karim-estimate-1",
        author: "contact",
        body: "Le budget est validé de notre côté. Peux-tu ajouter l’accompagnement au lancement dans la proposition finale ?",
        time: "10:58",
      },
      {
        id: "karim-estimate-2",
        author: "contact",
        body: "Si tu me l’envoies aujourd’hui, je peux faire signer le devis avant demain midi.",
        time: "11:02",
      },
    ],
  },
  {
    ...
    name: "Chloé Bernard",
    initials: "CB",
    address: "#client-atlas",
    channel: "slack",
    contactType: "client",
    subject: "Retour de recette sur le portail",
    preview:
      "Le parcours principal est validé. Il reste deux détails sur la gestion des invitations.",
    time: "52 min",
    unread: true,
    labels: ["client"],
    project: "Portail client Atlas",
    ...
    messages: [
      {
        id: "chloe-atlas-1",
        author: "contact",
        body: "Le parcours principal est validé. Il reste deux détails sur la gestion des invitations.",
        time: "10:31",
      },
      {
        id: "chloe-atlas-2",
        author: "me",
        body: "Je reprends ces deux points cet après-midi et je te partage une nouvelle build.",
        time: "10:37",
      },
    ],
  },
  {
    ...
    name: "Hugo Martin",
    initials: "HM",
    address: "hugo@studio-nova.fr",
    channel: "gmail",
    contactType: "supplier",
    subject: "Facture de production — bon pour paiement",
    preview:
      "La facture corrigée est jointe avec la bonne référence de commande.",
    time: "2h",
    unread: false,
    attachment: true,
    labels: ["finance"],
    messages: [
      {
        id: "hugo-invoice-1",
        author: "contact",
        body: "La facture corrigée est jointe avec la bonne référence de commande.",
        time: "09:44",
        attachment: "Facture-Nova-0926.pdf",
      },
    ],
  },
  {
    id: "emma-design-system",
    name: "Emma Rossi",
    initials: "ER",
    address: "#design-system",
    channel: "slack",
    contactType: "collaborator",
    subject: "Composants prêts pour la revue",
    preview:
      "Les états vides, les toasts et les skeletons sont prêts dans la branche de revue.",
    time: "3h",
    unread: false,
    ...
    messages: [
      {
        id: "emma-design-1",
        author: "contact",
        body: "Les états vides, les toasts et les skeletons sont prêts dans la branche de revue.",
        time: "08:52",
      },
      {
        id: "emma-design-2",
        author: "me",
        body: "Parfait, je vérifie surtout la transition entre skeleton et contenu réel.",
        time: "08:59",
      },
    ],
  },
  {
    ...
    name: "Romain Petit",
    initials: "RP",
    address: "romain@northstar.co",
    channel: "gmail",
    contactType: "client",
    subject: "Ordre du jour du kickoff de demain",
    preview:
      "Voici les participants confirmés et les trois décisions attendues pendant le kickoff.",
    time: "4h",
    unread: true,
    labels: ["client"],
    project: "Partenariat Northstar",
    ...
    messages: [
      {
        id: "romain-kickoff-1",
        author: "contact",
        body: "Voici les participants confirmés et les trois décisions attendues pendant le kickoff.",
        time: "08:11",
      },
      {
        id: "romain-kickoff-2",
        author: "contact",
        body: "Peux-tu ajouter cinq minutes sur les prochaines étapes à la fin de la réunion ?",
        time: "08:13",
      },
    ],
  },
  {
    ...
    channel: "slack",
    contactType: "collaborator",
    subject: "Planning de mise en ligne",
    preview:
      "Le créneau de mardi matin est réservé. J’ai ajouté la checklist dans le canal.",
    time: "5h",
    unread: false,
    labels: ["waiting"],
    project: "Lancement Freescale",
    ...
    messages: [
      {
        id: "ines-operations-1",
        author: "contact",
        body: "Le créneau de mardi matin est réservé. J’ai ajouté la checklist dans le canal.",
        time: "07:26",
      },
    ],
  },
  {
    ...
    name: "Louis Garnier",
    initials: "LG",
    address: "louis@atlaslabs.io",
    channel: "gmail",
    contactType: "client",
    subject: "Accès au tableau de bord analytics",
    preview:
      "Les accès ont été créés pour toute l’équipe produit. Tu peux vérifier les permissions.",
    time: "Hier",
    unread: false,
    labels: ["client"],
    project: "Portail client Atlas",
    ...
    messages: [
      {
        id: "louis-analytics-1",
        author: "contact",
        body: "Les accès ont été créés pour toute l’équipe produit. Tu peux vérifier les permissions.",
        time: "Hier · 17:42",
      },
      {
        id: "louis-analytics-2",
        author: "me",
        body: "C’est bon pour moi. Je prépare une première lecture des données avant notre point.",
        time: "Hier · 17:51",
      },
    ],
  },
  {
    ...
    name: "Nina Costa",
    initials: "NC",
    address: "#northstar-project",
    channel: "slack",
    contactType: "client",
    subject: "Contenus reçus pour la landing page",
    preview:
      "Les témoignages clients et les chiffres clés sont dans le dossier partagé.",
    time: "Hier",
    unread: true,
    labels: ["client"],
    project: "Partenariat Northstar",
    ...
    messages: [
      {
        id: "nina-northstar-1",
        author: "contact",
        body: "Les témoignages clients et les chiffres clés sont dans le dossier partagé.",
        time: "Hier · 16:08",
      },
      {
        id: "nina-northstar-2",
        author: "contact",
        body: "Dis-moi s’il te manque un format ou une autorisation d’utilisation.",
        time: "Hier · 16:09",
      },
    ],
  },
  {
    ...
    name: "Arthur Morel",
    initials: "AM",
    address: "arthur@meridian.fr",
    channel: "gmail",
    contactType: "client",
    subject: "Compte rendu de l’atelier utilisateurs",
    preview:
      "Je t’envoie la synthèse des six entretiens et les verbatims prioritaires.",
    time: "Hier",
    unread: false,
    attachment: true,
    labels: ["client"],
    ...
    messages: [
      {
        id: "arthur-workshop-1",
        author: "contact",
        body: "Je t’envoie la synthèse des six entretiens et les verbatims prioritaires.",
        time: "Hier · 14:23",
        attachment: "Synthese-entretiens-Meridian.pdf",
      },
      {
        id: "arthur-workshop-2",
        author: "me",
        body: "Merci, je vais les intégrer au cadrage avant de reprendre les parcours.",
        time: "Hier · 14:31",
      },
    ],
  },
